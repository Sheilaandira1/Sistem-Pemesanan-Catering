package sheila07180_project4;
import Sheila07180_View.*;
//import Sheila07180_Entity.*;
//import Sheila07180_Controller.*;
//import java.util.Scanner;
//
public class Sheila07180_Project4 {       
...
//    
    public static void main(String[] args) {
        Sheila07180_Catering gui = new Sheila07180_Catering();
    }
...
//                            update(namacus,newalamat,newnotelp,newjumlahpes,newisi1,newisi2,newharga);
//                        }
//                    }
//                    break;
//                    
...
//        pelanggan.insert(namacustomer,alamat,notelp,jumlahpes);
//        menumakanan.insert(isi1, isi2, harga);
//        loop++;
//        }catch(Exception e){
...
//            System.out.println("Harga Pesanan : "+menumakanan.getData(i).getHarga());
...
//    }
//    
//    static void update(String nama, String newalamat, String newnotelp ,int newjumlahpes, String newisi1, String newisi2, int newharga){
//        for(int i=0;i<loop;i++){
